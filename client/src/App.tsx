...
import BranchPerformance from "@/pages/branch-performance";
import RegionalAnalytics from "@/pages/regional-analytics";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/branches" component={BranchPerformance} />
      <Route path="/regions" component={RegionalAnalytics} />
